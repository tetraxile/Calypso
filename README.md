...
The licenses found in the [LICENSE](LICENSE) file apply only to the source files in the [client/src/](client/src) and [server/](server) directories, unless otherwise stated.
